...
import { easeInOutSine, easeOutCubic, easeZoomTransition } from '@mysdk/core';
import { ANIMATION_PHASES } from '@mysdk/core';
...
// (easeZoomTransition is imported from @mysdk/core — createCubicBezier(0.2, 0.8, 0.2, 1))
